...
<t:commonLayout>
	<jsp:body>
		...
		<div class="card-body">
			...
			<form class="cart-text" id="join-form" action = "join_result.jsp" method = "post">
			<!-- username 입력 받기 -->
...
<!-- 		<input type = "submit" value ="가입하기" class="btn btn-outline-light"> -->
			<button type="button" onclick="check_validation()" class="btn btn-outline-light">가입하기</button>
			<!-- type="button" 을 하는 이유?
